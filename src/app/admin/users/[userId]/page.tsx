            ...
            {isLoading ? (
                <div className="grid gap-6 md:grid-cols-2">
                 ...
                 <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <DetailItem icon={<Shield />} label="Role" value={<Badge variant={user.role === 'admin' ? 'destructive' : 'secondary'}>{((user.role || 'member').charAt(0).toUpperCase() + (user.role || 'member').slice(1))}</Badge>} />
